...
export function ProductTile({ product, index = 0 }: ProductTileProps) {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <TiltCard className="h-full" intensity={7} lift={-7} scale={1.014}>
        <article className="product-card group" data-transition-source>
          <div className="product-card-media relative aspect-[4/5] overflow-hidden">
            <ResilientImage
            ...
            <div className="product-card-badge absolute left-3 top-3 flex items-center gap-2 rounded-full border border-white/15 bg-black/35 px-3 py-1.5 text-[10px] uppercase tracking-[0.2em] backdrop-blur-xl">
              <span className="status-dot" />
              Disponible
            </div>

            <div className="product-card-size-panel absolute inset-x-0 bottom-0 p-4">
          ...
          <div className="product-card-info flex items-end justify-between gap-4 p-4">
            ...
            <button
              ...
              className="product-card-cart-button flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white text-black transition hover:rotate-90 hover:bg-[var(--electric)]"
