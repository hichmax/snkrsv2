...
export function EditorialCard({
  ...
  return (
    ...
    >
      <Link href={href} className="editorial-card-link block h-full" data-transition-source>
        <TiltCard className="h-full">
          <article className="editorial-card">
            <div className="editorial-card-media relative aspect-[16/10] overflow-hidden md:aspect-[16/9]">
              ...
              <div className="editorial-card-icon absolute right-4 top-4 flex h-11 w-11 translate-y-2 items-center justify-center rounded-full border border-white/15 bg-black/35 opacity-0 backdrop-blur-md transition duration-300 group-hover:translate-y-0 group-hover:opacity-100">
